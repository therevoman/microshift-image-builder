...
SCRIPT_PID=$$
PODS_NS_LIST=(openshift-ovn-kubernetes openshift-service-ca openshift-ingress openshift-dns openshift-storage kube-system openshift-operator-lifecycle-manager)
PODS_CT_LIST=(2                        1                    1                 2             2                 4           2)
RETRIEVE_PODS=false
